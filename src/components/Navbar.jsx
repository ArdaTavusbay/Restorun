...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
      <h1 className='w-full text-3xl font-bold text-[#00df9a]'>RESTORUN</h1>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
        <h1 className='w-full text-3xl font-bold text-[#00df9a] m-4'>RESTORUN</h1>
          <li className='p-4 border-b border-gray-600'>Home</li>
          <li className='p-4 border-b border-gray-600'>Features</li>
          <li className='p-4 border-b border-gray-600'>Our Team</li>
          <li className='p-4 border-b border-gray-600'>Reports</li>
      </ul>
    </div>
  );
};
